...
def logHelper(response, context):
    httpcode = response['ResponseMetadata']['HTTPStatusCode']
    logging.info(f"Response code {code} for {context}")

...
def logHTTP(responseCode, op):
    responseCode=str(responseCode)
    message = f'self.table.{op} ended with response code {responseCode}.'
...
class DBHelper:
    ...
    def insert_lead(self, lead_hash: str, lead_provider: str, response: str):
        ...
        logHTTP(res['ResponseMetadata']['HTTPStatusCode'],'put_item')
    ...
    def check_duplicate_api_call(self, lead_hash: str, lead_provider: str):
        ...
        logHTTP(res['ResponseMetadata']['HTTPStatusCode'],'get_item')
        item = res.get('Item')
        if not item:
            return {
                "Duplicate_Api_Call": {
    ...
    def accepted_lead_not_sent_for_oem(self, oem: str, date: str):
        ...
        logHTTP(res['ResponseMetadata']['HTTPStatusCode'],'query')
    ...
    def delete_oem(self, oem: str):
        ...
        logHTTP(res['ResponseMetadata']['HTTPStatusCode'],'delete_item')

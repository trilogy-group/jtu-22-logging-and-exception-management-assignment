...
class DBHelper:
    ...
    def insert_lead(self, lead_hash: str, lead_provider: str, response: str):
        ...
        log_db_table_operation(res, self.table.put_item)
    ...
    def check_duplicate_api_call(self, lead_hash: str, lead_provider: str):
        ...
        log_db_table_operation(res, self.table.get_item)
        item = res.get('Item')
        if not item:
            return {
                "Duplicate_Api_Call": {
    ...
    def accepted_lead_not_sent_for_oem(self, oem: str, date: str):
        ...
        log_db_table_operation(res, self.table.query)
    ...
    def delete_oem(self, oem: str):
        ...
        log_db_table_operation(res, self.table.delete_item)

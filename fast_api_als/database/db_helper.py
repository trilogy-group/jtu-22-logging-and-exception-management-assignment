...
def log_db_table_operation(res, operation, function_name):
    code = res['ResponseMetadata']['HTTPStatusCode']
    logging.info(f"fn db_helper: fn {function_name} executed operation {operation}.response code: {code}")
...
class DBHelper:
    ...
    def insert_lead(self, lead_hash: str, lead_provider: str, response: str):
        ...
        log_db_table_operation(res,'put_item', inspect.currentframe().f_code.co_name)
    ...
    def check_duplicate_api_call(self, lead_hash: str, lead_provider: str):
        ...
        item = res.get('Item')
        log_db_table_operation(res, "get_item", inspect.currentframe().f_code.co_name)
        if not item:
            return {
                "Duplicate_Api_Call": {
                    "status": False,
    ...
    def accepted_lead_not_sent_for_oem(self, oem: str, date: str):
        ...
        log_db_table_operation(res, "query", inspect.currentframe().f_code.co_name)
    ...
    def delete_oem(self, oem: str):
        ...
        log_db_table_operation(res, "delete_item", inspect.currentframe().f_code.co_name)

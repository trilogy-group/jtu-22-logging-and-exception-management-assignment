...
def common_loggger(Operation,Response):
    StatusCode = Response['ResponseMetadata']['HTTPStatusCode']
    logging.info("The operation " + Operation + " has returned a Http response code : " + str(StatusCode))
...
class DBHelper:
    ...
    def delete_oem(self, oem: str):
        ...
        common_loggger("delete_item", res)

...
def table_logger(res, operation):
    status_code = res['ResponseMetadata']['HTTPStatusCode']
    logging.info(f"{operation} operation in table returned the status code {status_code}")
